...
fit_ELA_growth = lm(`SGP (Expectation=50)` ~ `IEP_Status` + School_Year + Grade, data = star_dem_ELA)
...
fit_G5Math_growth_bool = lm(`SGP (Expectation=50)` ~ School_Year_Bool + `Test 1 PR`, data = G5MathHistGrowth)
summary(fit_G5Math_growth_bool)
#AIC(fit_G5Math_growth)
#BIC(fit_G5Math_growth)
fit_G5Math_growth_ord = lm(`SGP (Expectation=50)` ~ School_Year + `Test 1 PR`, data = G5MathHistGrowth)
summary(fit_G5Math_growth_ord)

fit_G5Math_growth_fac = lm(`SGP (Expectation=50)` ~ School_Year_Factor + `Test 1 PR`, data = G5MathHistGrowth)
summary(fit_G5Math_growth_fac)
#AIC(fit_G5Math_growth)
#BIC(fit_G5Math_growth)

fit_G5Math_growth_dem = lm(`SGP (Expectation=50)` ~ School_Year_Bool + `IEP_Status` + `Low_Income_Status` + `504_Status` + `Test 1 PR`, data = G5MathHistGrowth)
